...
```js
var program = noptify(['node', 'file.js', '-d', '--dirname', './', '-p', '3000', 'jui-app.js', 'base.js'])
...
assert.deepEqual(opts, {
  ...
  dirname: './',
  argv: {
    remain: ['jui-app.js', 'base.js'],
    cooked: ['--debug', '--dirname', './', '--port', '3000', 'jui-app.js', 'base.js'],
    original: ['-d', '--dirname', './', '-p', '3000', 'jui-app.js', 'base.js']
  }
});
```
